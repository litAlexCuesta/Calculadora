...
public class Engine implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "=":
			...
			char[] operacionCadena = operacion.toCharArray(); 
			
			
			//SEPARO LOS DOS NUMEROS SI ENTRE MEDIAS HAY + - * O /
			String[] operacionSeparada = operacion.split("[+\\-*/]");
			
			
			//COJO EL CHAR DEL OPERADOR // AHORA ME QUEDA QUE RECOJA TAMBIEN NUMEROS NEGATIVOS
			operation = operacion.charAt(operacionSeparada[0].length());
			
			System.out.println(operation);
			
			for (String string : operacionSeparada) {
				System.out.println(string);
			}
			
			//PONGO EL TEXTO VACIO
			display.setText("");
